...
const (
	...
	// (PodStatus.State) PodStateScalingDownRecoveryDirty represents a pod that has transactions to be completed.
	// The Operator will wait until all transactions are processed
	PodStateScalingDownRecoveryDirty = "SCALING_DOWN_RECOVERY_PROCESSING"
